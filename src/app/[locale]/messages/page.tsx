    ...
    <div className="mx-auto max-w-2xl px-4 py-6">
      ...
      {conversations.length > 0 ? (
          ...
          {conversations.map((conv, index) => {
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 p-4 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 ${
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-12 text-center dark:border-gray-700 dark:bg-gray-900">
          ...
          <p className="mt-4 text-sm font-medium text-gray-900 dark:text-gray-100">{t("noMessages")}</p>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{t("noMessagesDesc")}</p>
        </div>
      )}
    </div>
  );
