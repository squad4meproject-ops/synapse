          ...
          <div className="relative px-6 pb-6">
            ...
            <div className="-mt-12 mb-3">
              {user.avatar_url ? (
                ...
                <div className="flex h-24 w-24 items-center justify-center rounded-full border-4 border-white dark:border-gray-900 bg-gradient-to-br from-primary-500 to-accent-500 text-3xl font-bold text-white shadow-md">
                  {initial}
                </div>
              )}
            </div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {user.social_links.map((link, i) => (
                    <a
                      ...
                      className="inline-flex items-center gap-1 rounded-full bg-gray-100 px-2.5 py-1 text-xs font-medium text-gray-600 transition-colors hover:bg-primary-50 hover:text-primary-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-primary-900/30 dark:hover:text-primary-400"
                    >
                      {link.label}
                    </a>
                  ))}
